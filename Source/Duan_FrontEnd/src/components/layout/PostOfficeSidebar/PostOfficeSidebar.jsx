...
import styles from "./PostOfficeSidebar.module.css";
      ...
      <div className={styles.header}>
        ...
        <ul className={styles.menu}>
          <li
            ...
            onClick={() => handleItemClick("dashboard", "/postofficehome")}
          >
          ...
          <li
            ...
            onClick={() => handleItemClick("Shipment", "/postofficeshipment")}
          >
          ...
          <li
            ...
            onClick={() => handleItemClick("orders", "/postofficeorder")}
          >
            <MdOutlineShoppingCart /> Orders
          </li>
          <li
            className={`${styles.menuItem} ${
              activeItem === "sendorders" ? styles.active : ""
            }`}
            onClick={() => handleItemClick("sendorders", "/postofficesendorder")}
          >
            <IoSend /> Delivery
          </li>
          <li
            className={`${styles.menuItem} ${
              activeItem === "manage" ? styles.active : ""
            }`}
            onClick={() => handleItemClick("manage", "/postofficemanage")}
          >
            <MdManageHistory /> Manage
          </li>
          <li
            className={`${styles.menuItem} ${
              activeItem === "driver" ? styles.active : ""
            }`}
            onClick={() => handleItemClick("driver", "/postofficedriver")}
          >
          ...
          <li
            ...
            onClick={() => handleItemClick("postoffice", "/postofficeinfo")}
          >
